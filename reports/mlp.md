...
*Residual distribution for channel 0, k=3.5*
    ...
    The largest train-test gap is **0.0306** at k=3.5. The model generalises well; train/test performance is closely matched.
    ...
    **MLP** achieves weak decoding performance with a best test R2 of **-0.0210** at k=3.5. We recommend using **k=3.5** for this model in the final BCI pipeline. For deployment in the Synapse App, this model is a good candidate due to its speed and ONNX compatibility.
